...
our %config = (
  ...
  perl_version => "5.32.1",
  perlargv => [ "VC-WIN32", "no-shared", "no-asm", "no-tests" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
